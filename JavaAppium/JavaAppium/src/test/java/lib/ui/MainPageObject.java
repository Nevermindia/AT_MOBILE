...
public class MainPageObject {
    ...
    public void assertElementHasContentDesc(String locator, String expected_text, String error_message) {
        WebElement element = waitForElementPresent(locator, "Element not found", 5);
        String actual_text = element.getAttribute("content-desc");
        Assert.assertEquals(error_message, expected_text, actual_text);
    }
    ...
    public void swipeElementToTheLeft(String locator, String error_message) {
        if (Platform.getInstance().isAndroid()) {
            ...
            action1.dragAndDropBy(element, 200, 0).build().perform();
